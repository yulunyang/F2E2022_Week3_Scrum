...
<template>
  <div class="w-full h-screen relative step3">
    <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full">
      ...
      <div class="flex justify-center mb-10 text-white w-full container mx-auto">
        ...
        <!-- </div> -->
        <div class="w-2/3 text-2xl text-white quote py-8 px-8 leading-loose tracking-widest">
      ...
      <div class="absolute w-full left-1/2 -translate-x-1/2 bottom-16 flex justify-end items-center container mx-auto z-50">
        ...
        <div class="flex">
          ...
          <a><img src="@/assets/img/understand-btn.png" class="object-contain" /></a>
        </div>
      </div>
  </div>
</template>
