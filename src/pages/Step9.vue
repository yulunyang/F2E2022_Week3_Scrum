  ...
  <div class="w-full main-h relative step9 mt-4">
    ...
    <div class="container mx-auto flex px-4">
      ...
      <div class="w-1/2 p-2">
        ...
        <div class="item text-white text-2xl scrum-bg-black p-3 h-36 flex items-center cursor-pointer" v-for="(item, idx) in array2" :key="idx" @click="selected2 = idx" :class="{ 'active': selected2 === idx }">
          <div class="w-1/12">
            <img src="@/assets/img/Union-arrow.png" class="object-contain block z-10 off" />
            <img src="@/assets/img/Union-arrow-active.png" class="object-contain z-10 on" />
          </div>
